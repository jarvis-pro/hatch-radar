...
const PROVIDERS: Provider[] = [
  ...
  fromCore(BlueprintsRepository, 'blueprints'),
  fromCore(ProcessesRepository, 'processes'),
  ...
  fromCore(CostRepository, 'cost'),
  fromCore(TranslationsRepository, 'translations'),
  ...
  fromCore(TranslationService, 'translation'),
