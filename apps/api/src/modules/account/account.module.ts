 ...
 *
 * 全局会话守卫 SessionAuthGuard 及其 @Public/@RequirePermission/@AuthUser 装饰器均在 `@/common`、
 * 经 AppModule 的 APP_GUARD 全局注册（fail-closed）；守卫读 Authorization: Bearer 头校验 token。
 * 守卫实例在根上下文实例化，注入的 AccountService 经本模块
